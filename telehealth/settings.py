...
#JWT configuration
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=1), # The access token (used to authenticate API requests) expires after 1 hour.
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7), # The refresh token lives for 7 days. It's used to get a new access token without re-logging in.
